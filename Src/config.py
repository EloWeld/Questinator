...
NAV = dict(
    ...
    EDIT_CARD="💳 Изменить данные вывода",
...
MSG = dict(
    ...
    BANK_INFO="ℹ Информация о банке: \n"
              ...
              "🔗 Сайт банка: {bankSite} \n"
              "🏳 Страна: {bankCountry} \n",
    INVALID_CARD="Неправильный номер карты! Попробуйте ещё раз",
    ...
    # === ANSWER === #
    INVALID_Q_ID="К сожалению вопрос #{} уже неактивен",
    ANSWER_MOTO="Введите ответ на вопрос <u>#{}</u>",
